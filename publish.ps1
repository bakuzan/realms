...
Write-Host "";
$user_input = Read-Host -Prompt "Do you want to release Wiki after publishing?"
Write-Host "";

$release = $false;
$src = Join-Path (Get-ScriptDirectory) "\bin\Release\netcoreapp3.1\publish\*";
$dst = "C:\inetpub\wwwroot\wiki";
...
Write-Host "";
Write-Host "Wiki published." -ForegroundColor (Get-OuputColour $release);
Write-Host "";
...
if ($release) {
    ...
    Write-Host "";
    Write-Host "Wiki released." -ForegroundColor "Green";
    Write-Host "";
}
